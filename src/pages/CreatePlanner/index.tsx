              ...
              <div>
                ...
                <div className="flex items-center justify-between w-full rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 px-4 h-[42px]">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 ${(form as any).weekends_off ? 'bg-blue-600' : 'bg-gray-200 dark:bg-slate-700'
                      }`}
                  >
                    <span
                      style={{ backgroundColor: '#ffffff' }}
                      className={`pointer-events-none inline-block h-4 w-4 transform rounded-full shadow ring-0 transition duration-200 ease-in-out ${(form as any).weekends_off ? 'translate-x-4' : 'translate-x-0'
                        }`}
                    />
                  </button>
                </div>
